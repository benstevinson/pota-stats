...
// Note: Grids that span multiple states are mapped to the state with most coverage
const GRID_TO_STATE: Record<string, string> = {
  // Alaska (field-level mappings)
  ...
  // Oregon
  'CN80': 'OR', 'CN81': 'OR', 'CN82': 'OR',
  'CN90': 'OR', 'CN91': 'OR', 'CN92': 'OR',

  // California
  'CM87': 'CA', 'CM88': 'CA', 'CM89': 'CA', 'CM93': 'CA', 'CM94': 'CA', 'CM95': 'CA', 'CM96': 'CA', 'CM97': 'CA', 'CM98': 'CA', 'CM99': 'CA',
  'DM03': 'CA', 'DM04': 'CA', 'DM05': 'CA', 'DM06': 'CA', 'DM07': 'CA',
  'DM12': 'CA', 'DM13': 'CA', 'DM14': 'CA', 'DM15': 'CA',
  'DM22': 'CA', 'DM23': 'CA', 'DM24': 'CA', 'DM25': 'CA',
  'DM32': 'CA', 'DM33': 'CA', 'DM34': 'CA',
  'DM42': 'CA', 'DM43': 'CA',
  ...
  // Colorado
  'DM58': 'CO', 'DM68': 'CO', 'DM78': 'CO', 'DM79': 'CO',
  ...
  // Nebraska
  'DN80': 'NE', 'DN81': 'NE', 'DN90': 'NE', 'DN91': 'NE',
  ...
  // Idaho
  'DN07': 'ID', 'DN08': 'ID', 'DN17': 'ID', 'DN18': 'ID', 'DN28': 'ID',
  ...
  // Iowa
  'EN31': 'IA', 'EN32': 'IA', 'EN41': 'IA', 'EN42': 'IA',

  // Missouri
  'EM38': 'MO', 'EM39': 'MO', 'EM48': 'MO', 'EM49': 'MO',

  // Arkansas
  'EM35': 'AR', 'EM36': 'AR', 'EM45': 'AR', 'EM46': 'AR',

  // Louisiana
  'EM30': 'LA', 'EM31': 'LA', 'EM32': 'LA', 'EM40': 'LA', 'EM41': 'LA', 'EM42': 'LA',

  // Mississippi
  'EM43': 'MS', 'EM51': 'MS', 'EM52': 'MS', 'EM53': 'MS',

  // Alabama
  'EM54': 'AL', 'EM62': 'AL', 'EM63': 'AL', 'EM64': 'AL',
  ...
  // Illinois
  'EN40': 'IL', 'EN50': 'IL', 'EN51': 'IL', 'EN60': 'IL', 'EN61': 'IL',
  'EM59': 'IL',

  // Indiana
  'EM69': 'IN', 'EM79': 'IN', 'EN70': 'IN',

  // Ohio
  'EM89': 'OH', 'EN80': 'OH', 'EN81': 'OH', 'EN90': 'OH', 'EN91': 'OH',
  ...
  // South Carolina
  'EM92': 'SC', 'EM93': 'SC', 'EM94': 'SC',

  // North Carolina
  'EM85': 'NC', 'EM86': 'NC', 'EM95': 'NC', 'EM96': 'NC', 'FM05': 'NC', 'FM06': 'NC',

  // Virginia
  'EM97': 'VA', 'FM07': 'VA', 'FM08': 'VA', 'FM16': 'VA', 'FM17': 'VA',

  // West Virginia
  'EM98': 'WV', 'EM99': 'WV', 'FM09': 'WV',
  ...
  // Pennsylvania
  'FN00': 'PA', 'FN01': 'PA', 'FN10': 'PA', 'FN11': 'PA', 'FN20': 'PA',

  // New Jersey
  'FN21': 'NJ', 'FN30': 'NJ',

  // New York
  'FN02': 'NY', 'FN03': 'NY', 'FN12': 'NY', 'FN13': 'NY',
  'FN22': 'NY', 'FN23': 'NY', 'FN31': 'NY', 'FN32': 'NY', 'FN33': 'NY',
  ...
  // Maine
  'FN45': 'ME', 'FN54': 'ME', 'FN55': 'ME', 'FN64': 'ME', 'FN65': 'ME',
};
